...
public final class Main {
	...
	public static void main(String[] args) {
		...
		clearConsole();
		System.out.println("Fatal error. Game exits after 3... 2...");
		try {
			Thread.sleep(3000);
	...
	{
		/**
		 * Resets the Database for a new game in case a game had already been played.
		 * */
		...
		do
		{
			...
			//Throws exception if player have tried to move on the other player's position.
